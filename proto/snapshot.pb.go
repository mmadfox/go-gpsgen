...
type Snapshot struct {
	...
	Navigator *Snapshot_Navigator    `protobuf:"bytes,9,opt,name=navigator,proto3" json:"navigator,omitempty"`
	Speed     *Snapshot_CommonType   `protobuf:"bytes,10,opt,name=speed,proto3" json:"speed,omitempty"`
	Battery   *Snapshot_BatteryType  `protobuf:"bytes,11,opt,name=battery,proto3" json:"battery,omitempty"`
	Sensors   []*Snapshot_SensorType `protobuf:"bytes,12,rep,name=sensors,proto3" json:"sensors,omitempty"`
}
...
type Snapshot_Curve struct {
	...
	Points []*Snapshot_Curve_ControlPoint `protobuf:"bytes,1,rep,name=points,proto3" json:"points,omitempty"`
...
type Snapshot_CommonType struct {
	...
	Gen *Snapshot_Curve `protobuf:"bytes,4,opt,name=gen,proto3" json:"gen,omitempty"`
}
...
type Snapshot_BatteryType struct {
	...
	Min        float64 `protobuf:"fixed64,1,opt,name=min,proto3" json:"min,omitempty"`
	Max        float64 `protobuf:"fixed64,2,opt,name=max,proto3" json:"max,omitempty"`
	ChargeTime int64   `protobuf:"varint,4,opt,name=charge_time,json=chargeTime,proto3" json:"charge_time,omitempty"`
	Val        float64 `protobuf:"fixed64,5,opt,name=val,proto3" json:"val,omitempty"`
}
...
type Snapshot_SensorType struct {
	...
	ValX float64         `protobuf:"fixed64,4,opt,name=val_x,json=valX,proto3" json:"val_x,omitempty"`
	ValY float64         `protobuf:"fixed64,5,opt,name=val_y,json=valY,proto3" json:"val_y,omitempty"`
	Name string          `protobuf:"bytes,6,opt,name=name,proto3" json:"name,omitempty"`
	Gen  *Snapshot_Curve `protobuf:"bytes,7,opt,name=gen,proto3" json:"gen,omitempty"`
}
...
type Snapshot_Curve_ControlPoint struct {
	...
	Vp *Snapshot_Curve_Point `protobuf:"bytes,1,opt,name=vp,proto3" json:"vp,omitempty"`
	Cp *Snapshot_Curve_Point `protobuf:"bytes,2,opt,name=cp,proto3" json:"cp,omitempty"`
}
...
func (*Snapshot_Navigator_Route) Descriptor() ([]byte, []int) {
	return file_proto_snapshot_proto_rawDescGZIP(), []int{0, 5, 0}
}
...
func (*Snapshot_Navigator_Route_Track) Descriptor() ([]byte, []int) {
	return file_proto_snapshot_proto_rawDescGZIP(), []int{0, 5, 0, 0}
}
...
func (*Snapshot_Navigator_Route_Track_Segment) Descriptor() ([]byte, []int) {
	return file_proto_snapshot_proto_rawDescGZIP(), []int{0, 5, 0, 0, 0}
}
...
var file_proto_snapshot_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x05, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x9d, 0x13,
	...
	0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f, 0x74, 0x2e, 0x43, 0x75, 0x72, 0x76, 0x65, 0x52, 0x03, 0x67,
	0x65, 0x6e, 0x1a, 0xc8, 0x0a, 0x0a, 0x09, 0x4e, 0x61, 0x76, 0x69, 0x67, 0x61, 0x74, 0x6f, 0x72,
	0x12, 0x37, 0x0a, 0x06, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b,
	0x32, 0x1f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x53, 0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f,
	0x74, 0x2e, 0x4e, 0x61, 0x76, 0x69, 0x67, 0x61, 0x74, 0x6f, 0x72, 0x2e, 0x52, 0x6f, 0x75, 0x74,
	0x65, 0x52, 0x06, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x73, 0x12, 0x1f, 0x0a, 0x0b, 0x72, 0x6f, 0x75,
	...
	0x0a, 0x74, 0x72, 0x61, 0x63, 0x6b, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x12, 0x23, 0x0a, 0x0d, 0x73,
	...
	,
	...
	,
	...
	0x61, 0x6e, 0x63, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x63, 0x6f, 0x6c, 0x6f, 0x72, 0x18, 0x03, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x05, 0x63, 0x6f, 0x6c, 0x6f, 0x72, 0x12, 0x3d, 0x0a, 0x06, 0x74, 0x72,
	0x61, 0x63, 0x6b, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x25, 0x2e, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x2e, 0x53, 0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f, 0x74, 0x2e, 0x4e, 0x61, 0x76, 0x69,
	0x67, 0x61, 0x74, 0x6f, 0x72, 0x2e, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x2e, 0x54, 0x72, 0x61, 0x63,
	0x6b, 0x52, 0x06, 0x74, 0x72, 0x61, 0x63, 0x6b, 0x73, 0x12, 0x14, 0x0a, 0x05, 0x70, 0x72, 0x6f,
	0x70, 0x73, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x05, 0x70, 0x72, 0x6f, 0x70, 0x73, 0x12,
	...
	,
	...
	,
...
var file_proto_snapshot_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_proto_snapshot_proto_goTypes = []interface{}{
	...
	(*Snapshot_Navigator)(nil),                     // 6: proto.Snapshot.Navigator
	(*Snapshot_Curve_Point)(nil),                   // 7: proto.Snapshot.Curve.Point
	(*Snapshot_Curve_ControlPoint)(nil),            // 8: proto.Snapshot.Curve.ControlPoint
	(*Snapshot_Navigator_Route)(nil),               // 9: proto.Snapshot.Navigator.Route
	(*Snapshot_Navigator_Route_Track)(nil),         // 10: proto.Snapshot.Navigator.Route.Track
	(*Snapshot_Navigator_Route_Track_Segment)(nil), // 11: proto.Snapshot.Navigator.Route.Track.Segment
}
var file_proto_snapshot_proto_depIdxs = []int32{
	6,  // 0: proto.Snapshot.navigator:type_name -> proto.Snapshot.Navigator
	...
	8,  // 4: proto.Snapshot.Curve.points:type_name -> proto.Snapshot.Curve.ControlPoint
	...
	9,  // 7: proto.Snapshot.Navigator.routes:type_name -> proto.Snapshot.Navigator.Route
	1,  // 8: proto.Snapshot.Navigator.point:type_name -> proto.Snapshot.PointLatLon
	5,  // 9: proto.Snapshot.Navigator.elevation:type_name -> proto.Snapshot.SensorType
	7,  // 10: proto.Snapshot.Curve.ControlPoint.vp:type_name -> proto.Snapshot.Curve.Point
	7,  // 11: proto.Snapshot.Curve.ControlPoint.cp:type_name -> proto.Snapshot.Curve.Point
	10, // 12: proto.Snapshot.Navigator.Route.tracks:type_name -> proto.Snapshot.Navigator.Route.Track
	11, // 13: proto.Snapshot.Navigator.Route.Track.segmenets:type_name -> proto.Snapshot.Navigator.Route.Track.Segment
	1,  // 14: proto.Snapshot.Navigator.Route.Track.Segment.point_a:type_name -> proto.Snapshot.PointLatLon
	1,  // 15: proto.Snapshot.Navigator.Route.Track.Segment.point_b:type_name -> proto.Snapshot.PointLatLon
