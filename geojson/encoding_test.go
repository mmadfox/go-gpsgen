	...
	tests := []struct {
		...
		},
		{
			...
			assert: func(routes []*navigator.Route) {
				...
				require.Equal(t, 1189.315916641673, route.Distance())
				...
				require.Equal(t, 1189.315916641673, track.Distance())
		...
		},
		{
			...
			assert: func(routes []*navigator.Route) {
				...
				require.Equal(t, 2652.039495805213, route1.Distance())
				require.Equal(t, "#9d031c", route1.Color())
				...
				require.Equal(t, 1990.2240332037318, route1track1.Distance())
