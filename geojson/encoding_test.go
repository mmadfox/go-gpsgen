	...
	tests := []struct {
		...
		},
		{
			...
			assert: func(routes []*navigator.Route) {
				...
				require.Equal(t, 1189.0, math.Floor(route.Distance()))
				...
				require.Equal(t, 1189.0, math.Floor(track.Distance()))
		...
		},
		{
			...
			assert: func(routes []*navigator.Route) {
				...
				require.Equal(t, 2652.0, math.Floor(route1.Distance()))
				require.Equal(t, "#9d031c", route1.Color())
				...
				require.Equal(t, 1990.0, math.Floor(route1track1.Distance()))
