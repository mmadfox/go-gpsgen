...
### Маршруты
Маршрут для GPX генератора - это заданный путь или последовательность точек на карте, которые определяют планируемое или фиксированное перемещение геотрекера. 
#### GeoJSON
```go
package main
